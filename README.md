...
- 🐛 **バグ報告**: [GitHub Issues](https://github.com/SuperClaude/SuperClaudeForCursor/issues)
- 💬 **ディスカッション**: [GitHub Discussions](https://github.com/SuperClaude/SuperClaudeForCursor/discussions)
...
- [SuperClaude](https://superclaude.ai) - 強力な AI 拡張フレームワーク
- [Cursor IDE](https://cursor.sh) - 次世代 AI 統合エディタ
- [ClaudeCode](https://claude.ai) - 高度な AI アシスタント
- オープンソースコミュニティの皆様
